...
namespace FunctionalNetworkUI
{
    ...
    /// </summary>
    public class ExecutionConnectorItem : ContentControl
    {
        #region Dependency Property/Event Definitions

        public static readonly DependencyProperty HotspotProperty =
            DependencyProperty.Register("Hotspot", typeof(Point), typeof(ExecutionConnectorItem));

        internal static readonly DependencyProperty ParentNetworkViewProperty =
            DependencyProperty.Register("ParentNetworkView", typeof(NetworkView), typeof(ExecutionConnectorItem),
        ...
        internal static readonly DependencyProperty ParentNodeItemProperty =
            DependencyProperty.Register("ParentNodeItem", typeof(NodeItem), typeof(ExecutionConnectorItem));

        internal static readonly RoutedEvent ExecutionConnectorDragStartedEvent =
            EventManager.RegisterRoutedEvent("ExecutionConnectorDragStarted", RoutingStrategy.Bubble, typeof(ExecutionConnectorItemDragStartedEventHandler), typeof(ExecutionConnectorItem));

        internal static readonly RoutedEvent ExecutionConnectorDraggingEvent =
            EventManager.RegisterRoutedEvent("ExecutionConnectorDragging", RoutingStrategy.Bubble, typeof(ExecutionConnectorItemDraggingEventHandler), typeof(ExecutionConnectorItem));

        internal static readonly RoutedEvent ExecutionConnectorDragCompletedEvent =
            EventManager.RegisterRoutedEvent("ExecutionConnectorDragCompleted", RoutingStrategy.Bubble, typeof(ExecutionConnectorItemDragCompletedEventHandler), typeof(ExecutionConnectorItem));
        ...
        public ExecutionConnectorItem()
        {
            ...
            //
            this.LayoutUpdated += new EventHandler(ExecutionConnectorItem_LayoutUpdated);
        }
        ...
        /// Static constructor.
        /// </summary>
        static ExecutionConnectorItem()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ExecutionConnectorItem), new FrameworkPropertyMetadata(typeof(ExecutionConnectorItem)));
        }
        ...
        protected override void OnMouseUp(MouseButtonEventArgs e)
        {
            ...
            if (e.ChangedButton == MouseButton.Left)
            {
                if (isLeftMouseDown)
                {
                    if (isDragging)
                    {
                        RaiseEvent(new ExecutionConnectorItemDragCompletedEventArgs(ExecutionConnectorDragCompletedEvent, this));
        ...
        /// </summary>
        internal void CancelExecutionConnectionDragging()
        {
            if (isLeftMouseDown)
            {
                //
                ...
                //
                RaiseEvent(new ExecutionConnectorItemDragCompletedEventArgs(ExecutionConnectorDragCompletedEvent, null));
        ...
        {
            ExecutionConnectorItem c = (ExecutionConnectorItem)d;
            c.UpdateHotspot();
        }
        ...
        /// </summary>
        private void ExecutionConnectorItem_LayoutUpdated(object sender, EventArgs e)
        {
            UpdateHotspot();
        }
