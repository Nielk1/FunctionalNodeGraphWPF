...
namespace FunctionalNetworkModel
{
    ...
    /// </summary>
    public sealed class ExecutionConnectionViewModel : AbstractModelBase
    {
        ...
        /// </summary>
        private ExecutionConnectorViewModel sourceConnector = null;

        /// <summary>
        /// The destination connector the connection is attached to.
        /// </summary>
        private ExecutionConnectorViewModel destConnector = null;
        ...
        /// The source connector the connection is attached to.
        /// </summary>
        public ExecutionConnectorViewModel SourceConnector
        {
            get
            {
            ...
            set
            {
                ...
                {
                    sourceConnector.AttachedExecutionConnections.Remove(this);
                ...
                if (sourceConnector != null)
                {
                    sourceConnector.AttachedExecutionConnections.Add(this);
                    sourceConnector.HotspotUpdated += new EventHandler<EventArgs>(sourceConnector_HotspotUpdated);
        ...
        /// The destination connector the connection is attached to.
        /// </summary>
        public ExecutionConnectorViewModel DestConnector
        {
            get
            {
            ...
            set
            {
                ...
                {
                    destConnector.AttachedExecutionConnections.Remove(this);
                ...
                if (destConnector != null)
                {
                    destConnector.AttachedExecutionConnections.Add(this);
                    destConnector.HotspotUpdated += new EventHandler<EventArgs>(destConnector_HotspotUpdated);
