...
namespace FunctionalNetworkUI
{
    ...
    public partial class NetworkView : Control
    {
        ...
        private static readonly DependencyPropertyKey ExecutionConnectionsPropertyKey =
            DependencyProperty.RegisterReadOnly("ExecutionConnections", typeof(ImpObservableCollection<object>), typeof(NetworkView),
                new FrameworkPropertyMetadata());
        public static readonly DependencyProperty ExecutionConnectionsProperty = ExecutionConnectionsPropertyKey.DependencyProperty;




        public static readonly DependencyProperty ExecutionConnectionsSourceProperty =
            DependencyProperty.Register("ExecutionConnectionsSource", typeof(IEnumerable), typeof(NetworkView),
                new FrameworkPropertyMetadata(ExecutionConnectionsSource_PropertyChanged));
        ...
        public static readonly DependencyProperty EnableExecutionConnectionDraggingProperty =
            DependencyProperty.Register("EnableExecutionConnectionDragging", typeof(bool), typeof(NetworkView),
                new FrameworkPropertyMetadata(true));

        private static readonly DependencyPropertyKey IsDraggingExecutionConnectionPropertyKey =
            DependencyProperty.RegisterReadOnly("IsDraggingExecutionConnection", typeof(bool), typeof(NetworkView),
                new FrameworkPropertyMetadata(false));
        public static readonly DependencyProperty IsDraggingExecutionConnectionProperty = IsDraggingExecutionConnectionPropertyKey.DependencyProperty;

        private static readonly DependencyPropertyKey IsNotDraggingExecutionConnectionPropertyKey =
            DependencyProperty.RegisterReadOnly("IsNotDraggingExecutionConnection", typeof(bool), typeof(NetworkView),
                new FrameworkPropertyMetadata(true));
        public static readonly DependencyProperty IsNotDraggingExecutionConnectionProperty = IsNotDraggingExecutionConnectionPropertyKey.DependencyProperty;
        ...
        public static readonly DependencyProperty ExecutionConnectionItemTemplateProperty =
            DependencyProperty.Register("ExecutionConnectionItemTemplate", typeof(DataTemplate), typeof(NetworkView));

        public static readonly DependencyProperty ExecutionConnectionItemTemplateSelectorProperty =
            DependencyProperty.Register("ExecutionConnectionItemTemplateSelector", typeof(DataTemplateSelector), typeof(NetworkView));

        public static readonly DependencyProperty ExecutionConnectionItemContainerStyleProperty =
            DependencyProperty.Register("ExecutionConnectionItemContainerStyle", typeof(Style), typeof(NetworkView));
        ...
        public static readonly RoutedEvent NodeDoubleClickEvent =
            EventManager.RegisterRoutedEvent("NodeDoubleClick", RoutingStrategy.Bubble, typeof(NodeDoubleClickEventHandler), typeof(NetworkView));
        ...
        public static readonly RoutedEvent ExecutionConnectionDragStartedEvent =
            EventManager.RegisterRoutedEvent("ExecutionConnectionDragStarted", RoutingStrategy.Bubble, typeof(ExecutionConnectionDragStartedEventHandler), typeof(NetworkView));

        public static readonly RoutedEvent QueryExecutionConnectionFeedbackEvent =
            EventManager.RegisterRoutedEvent("QueryExecutionConnectionFeedback", RoutingStrategy.Bubble, typeof(QueryExecutionConnectionFeedbackEventHandler), typeof(NetworkView));

        public static readonly RoutedEvent ExecutionConnectionDraggingEvent =
            EventManager.RegisterRoutedEvent("ExecutionConnectionDragging", RoutingStrategy.Bubble, typeof(ExecutionConnectionDraggingEventHandler), typeof(NetworkView));

        public static readonly RoutedEvent ExecutionConnectionDragCompletedEvent =
            EventManager.RegisterRoutedEvent("ExecutionConnectionDragCompleted", RoutingStrategy.Bubble, typeof(ExecutionConnectionDragCompletedEventHandler), typeof(NetworkView));
        ...
        public static readonly RoutedCommand CancelExecutionConnectionDraggingCommand = null;
        ...
        /// </summary>
        private ItemsControl executionConnectionItemsControl = null;
        ...
        public NetworkView()
        {
            ...
            //
            this.ExecutionConnections = new ImpObservableCollection<object>();
            ...
            //
            AddHandler(NodeItem.NodeDoubleClickEvent, new NodeDoubleClickEventHandler(NodeItem_DoubleClick));
            ...
            AddHandler(ExecutionConnectorItem.ExecutionConnectorDragStartedEvent, new ExecutionConnectorItemDragStartedEventHandler(ExecutionConnectorItem_DragStarted));
            AddHandler(ExecutionConnectorItem.ExecutionConnectorDraggingEvent, new ExecutionConnectorItemDraggingEventHandler(ExecutionConnectorItem_Dragging));
            AddHandler(ExecutionConnectorItem.ExecutionConnectorDragCompletedEvent, new ExecutionConnectorItemDragCompletedEventHandler(ExecutionConnectorItem_DragCompleted));
        ...
        /// </summary>
        public event ExecutionConnectionDragStartedEventHandler ExecutionConnectionDragStarted
        {
            add { AddHandler(ExecutionConnectionDragStartedEvent, value); }
            remove { RemoveHandler(ExecutionConnectionDragStartedEvent, value); }
        }
        ...
        /// </summary>
        public event QueryExecutionConnectionFeedbackEventHandler QueryExecutionConnectionFeedback
        {
            add { AddHandler(QueryExecutionConnectionFeedbackEvent, value); }
            remove { RemoveHandler(QueryExecutionConnectionFeedbackEvent, value); }
        }

        /// <summary>
        /// Event raised when a connection is being dragged.
        /// </summary>
        public event ExecutionConnectionDraggingEventHandler ExecutionConnectionDragging
        {
            add { AddHandler(ExecutionConnectionDraggingEvent, value); }
            remove { RemoveHandler(ExecutionConnectionDraggingEvent, value); }
        }

        /// <summary>
        /// Event raised when the user has completed dragging a connection in the network.
        /// </summary>
        public event ExecutionConnectionDragCompletedEventHandler ExecutionConnectionDragCompleted
        {
            add { AddHandler(ExecutionConnectionDragCompletedEvent, value); }
            remove { RemoveHandler(ExecutionConnectionDragCompletedEvent, value); }
        }
        ...
        /// </summary>
        public ImpObservableCollection<object> ExecutionConnections
        {
            get
            {
                return (ImpObservableCollection<object>)GetValue(ExecutionConnectionsProperty);
            }
            private set
            {
                SetValue(ExecutionConnectionsPropertyKey, value);
            }
        }
        ...
        /// Used in the same way as 'ItemsSource' in 'ItemsControl'.
        /// </summary>
        public IEnumerable ExecutionConnectionsSource
        {
            get
            {
                return (IEnumerable)GetValue(ExecutionConnectionsSourceProperty);
            }
            set
            {
                SetValue(ExecutionConnectionsSourceProperty, value);
            }
        }
        ...
        /// </summary>
        public bool IsDraggingExecutionConnection
        {
            get
            {
                return (bool)GetValue(IsDraggingExecutionConnectionProperty);
            }
            private set
            {
                SetValue(IsDraggingExecutionConnectionPropertyKey, value);
            }
        }
        ...
        /// dragging out a connection.
        /// </summary>
        public bool IsNotDraggingExecutionConnection
        {
            get
            {
                return (bool)GetValue(IsNotDraggingExecutionConnectionProperty);
            }
            private set
            {
                SetValue(IsNotDraggingExecutionConnectionPropertyKey, value);
            }
        }
        ...
        /// </summary>
        public void CancelExecutionConnectionDragging()
        {
            if (!this.IsDraggingExecutionConnection)
            {
                return;
            }
            ...
            draggedOutExecutionConnectorItem.CancelExecutionConnectionDragging();
        ...
        static NetworkView()
        {
            ...
            CancelExecutionConnectionDraggingCommand = new RoutedCommand("CancelExecutionConnectionDragging", typeof(NetworkView));
            ...
            binding = new CommandBinding();
            binding.Command = CancelExecutionConnectionDraggingCommand;
            binding.Executed += new ExecutedRoutedEventHandler(CancelExecutionConnectionDragging_Executed);
            CommandManager.RegisterClassCommandBinding(typeof(NetworkView), binding);
        }
        ...
        /// <summary>
        /// Executes the 'CancelExecutionConnectionDragging' command.
        /// </summary>
        private static void CancelExecutionConnectionDragging_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            NetworkView c = (NetworkView)sender;
            c.CancelExecutionConnectionDragging();
        }
        ...
        /// <summary>
        /// Event raised when a new collection has been assigned to the 'ExecutionConnectionsSource' property.
        /// </summary>
        private static void ExecutionConnectionsSource_PropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            NetworkView c = (NetworkView)d;
            ...
            if (e.OldValue != null)
            {
                ...
                if (notifyCollectionChanged != null)
                {
                    ...
                    // Unhook events from previous collection.
                    //
                    notifyCollectionChanged.CollectionChanged -= new NotifyCollectionChangedEventHandler(c.ExecutionConnectionsSource_CollectionChanged);
                }
            }
            ...
            if (e.NewValue != null)
            {
                ...
                {
                    //
                    // Populate 'ExecutionConnections' from 'ExecutionConnectionsSource'.
                    //
                    foreach (object obj in enumerable)
                    {
        ...
        /// <summary>
        /// Event raised when a connection has been added to or removed from the collection assigned to 'ExecutionConnectionsSource'.
        /// </summary>
        private void ExecutionConnectionsSource_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Reset)
            {
                //
                // 'ExecutionConnectionsSource' has been cleared, also clear 'Connections'.
                //
            ...
            else
            {
                ...
                {
                    //
                    // For each item that has been removed from 'ExecutionConnectionsSource' also remove it from 'Connections'.
                    //
                    foreach (object obj in e.OldItems)
                    {
                        ExecutionConnections.Remove(obj);
                    }
                }
                ...
                {
                    //
                    // For each item that has been added to 'ExecutionConnectionsSource' also add it to 'Connections'.
                    //
                    foreach (object obj in e.NewItems)
                    {
                        ExecutionConnections.Add(obj);
                    }
                }
            }
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.executionConnectionItemsControl = (ItemsControl)this.Template.FindName("PART_ExecutionConnectionItemsControl", this);
            if (this.executionConnectionItemsControl == null)
            {
                throw new ApplicationException("Failed to find 'PART_ExecutionConnectionItemsControl' in the visual tree for 'NetworkView'.");
            }
