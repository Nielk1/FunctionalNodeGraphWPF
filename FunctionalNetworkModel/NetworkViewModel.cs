...
namespace FunctionalNetworkModel
{
    ...
    public sealed class NetworkViewModel
    {
        ...
        /// </summary>
        private ImpObservableCollection<ExecutionConnectionViewModel> executionConnections = null;
        ...
        /// The collection of connections in the network.
        /// </summary>
        public ImpObservableCollection<ExecutionConnectionViewModel> ExecutionConnections
        {
            get
            {
                if (executionConnections == null)
                {
                    executionConnections = new ImpObservableCollection<ExecutionConnectionViewModel>();
                    executionConnections.ItemsRemoved += new EventHandler<CollectionItemsChangedEventArgs>(executionConnections_ItemsRemoved);
                }
        ...
        /// </summary>
        private void executionConnections_ItemsRemoved(object sender, CollectionItemsChangedEventArgs e)
        {
