...
namespace FunctionalNetworkUI
{
    ...
    public class NodeItem : ListBoxItem
    {
        ...
        internal static readonly RoutedEvent NodeDoubleClickEvent =
            EventManager.RegisterRoutedEvent("NodeDoubleClick", RoutingStrategy.Bubble, typeof(NodeDoubleClickEventHandler), typeof(NodeItem));
