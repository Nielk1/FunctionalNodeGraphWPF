...
namespace FunctionalNetworkModel
{
    ...
    /// </summary>
    public abstract /*sealed*/ class NodeViewModel : AbstractModelBase, IDisposable
    {
        ...
        /// </summary>
        private ImpObservableCollection<ExecutionConnectorViewModel> inputExecutionConnectors = null;

        /// <summary>
        /// List of output connectors (connections points) attached to the node.
        /// </summary>
        private ImpObservableCollection<ExecutionConnectorViewModel> outputExecutionConnectors = null;
        ...
        //public abstract NodeExecutionType ExecutionType { get; }
        ...
        /// List of input connectors (connections points) attached to the node.
        /// </summary>
        public ImpObservableCollection<ExecutionConnectorViewModel> InputExecutionConnectors
        {
            get
            {
                if (inputExecutionConnectors == null)
                {
                    inputExecutionConnectors = new ImpObservableCollection<ExecutionConnectorViewModel>();
                    inputExecutionConnectors.ItemsAdded += new EventHandler<CollectionItemsChangedEventArgs>(inputExecutionConnectors_ItemsAdded);
                    inputExecutionConnectors.ItemsRemoved += new EventHandler<CollectionItemsChangedEventArgs>(inputExecutionConnectors_ItemsRemoved);
                }

                return inputExecutionConnectors;
            }
        }
        ...
        /// List of input connectors (connections points) attached to the node.
        /// </summary>
        public ImpObservableCollection<ExecutionConnectorViewModel> OutputExecutionConnectors
        {
            get
            {
                if (outputExecutionConnectors == null)
                {
                    outputExecutionConnectors = new ImpObservableCollection<ExecutionConnectorViewModel>();
                    outputExecutionConnectors.ItemsAdded += new EventHandler<CollectionItemsChangedEventArgs>(outputExecutionConnectors_ItemsAdded);
                    outputExecutionConnectors.ItemsRemoved += new EventHandler<CollectionItemsChangedEventArgs>(outputExecutionConnectors_ItemsRemoved);
                }

                return outputExecutionConnectors;
            }
        }
        ...
        /// </summary>
        public ICollection<ExecutionConnectionViewModel> AttachedExecutionConnections
        {
            get
            {
                List<ExecutionConnectionViewModel> attachedExecutionConnections = new List<ExecutionConnectionViewModel>();

                foreach (var connector in this.InputExecutionConnectors)
                {
                    attachedExecutionConnections.AddRange(connector.AttachedExecutionConnections);
                }

                foreach (var connector in this.OutputExecutionConnectors)
                {
                    attachedExecutionConnections.AddRange(connector.AttachedExecutionConnections);
                }

                return attachedExecutionConnections;
            }
        }
        ...
        /// </summary>
        private void inputExecutionConnectors_ItemsAdded(object sender, CollectionItemsChangedEventArgs e)
        {
            foreach (ExecutionConnectorViewModel connector in e.Items)
            {
        ...
        /// </summary>
        private void inputExecutionConnectors_ItemsRemoved(object sender, CollectionItemsChangedEventArgs e)
        {
            foreach (ExecutionConnectorViewModel connector in e.Items)
            {
        ...
        /// Event raised when connectors are added to the node.
        /// </summary>
        private void outputExecutionConnectors_ItemsAdded(object sender, CollectionItemsChangedEventArgs e)
        {
            foreach (ExecutionConnectorViewModel connector in e.Items)
            {
                connector.ParentNode = this;
        ...
        /// Event raised when connectors are removed from the node.
        /// </summary>
        private void outputExecutionConnectors_ItemsRemoved(object sender, CollectionItemsChangedEventArgs e)
        {
            foreach (ExecutionConnectorViewModel connector in e.Items)
            {
                connector.ParentNode = null;
